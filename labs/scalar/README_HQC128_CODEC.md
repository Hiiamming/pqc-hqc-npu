...
The old codec demo entrypoint was removed during cleanup. This lab now keeps
only decoder benchmarks used by the simulator and device measurement flow. The
benchmark scripts expect the tutorial tools layout under `../tools`, or these
