...
OUT="$PROJECT_DIR/build/hqc256_decode_bench_hexagon"
...
echo "=== Compiling HQC-256 decode benchmark for Hexagon HVX intrinsic, iters=$BENCH_ITERS, gf_lut=$GF_LUT_MUL, gf_hwstyle=$GF_HWSTYLE_MUL, hvx_rs_syndrome=$HVX_RS_SYNDROME ==="
"$CLANG" -O2 -mv75 \
