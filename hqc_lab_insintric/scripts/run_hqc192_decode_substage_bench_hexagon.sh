...
echo "=== Compiling HQC-192 substage benchmark for Hexagon HVX intrinsic, substage=$SUBSTAGE, iters=$BENCH_ITERS, gf_lut=$GF_LUT_MUL, gf_hwstyle=$GF_HWSTYLE_MUL, hvx_rs_syndrome=$HVX_RS_SYNDROME ==="
"$CLANG" -O2 -mv75 \
