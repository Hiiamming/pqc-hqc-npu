...
Environment:
  ...
  OUT_ROOT            local output root. Default: results/qprof/qprof_hqc_runs
...
OUT_ROOT="${OUT_ROOT:-$ROOT_DIR/results/qprof/qprof_hqc_runs}"
