...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(hqc_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
...
__QAIC_HEADER_EXPORT int __QAIC_HEADER(hqc_decode_bench_count)(remote_handle64 _h, int decode_count, int* total_decodes, int* total_rs_symbol_errors, int* checksum, int* passed) __QAIC_HEADER_ATTRIBUTE;
